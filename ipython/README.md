A docker container for running [IPython 4.0](http://ipython.org/) over Python 3, and the development version of [Spot](https://spot.lrde.epita.fr/) (i.e., what will eventually become Spot 2.0).
